...
public class DreamRepository : IDreamRepository {
  public void AddDream(Dream dream) { throw new NotImplementedException(); }

  public List<Dream> GetAllDreams() { throw new NotImplementedException(); }

  public Dream GetDreamById(Guid id) { throw new NotImplementedException(); }
